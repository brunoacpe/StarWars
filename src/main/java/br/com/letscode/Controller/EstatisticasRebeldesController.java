...
public class EstatisticasRebeldesController {
    ...
    public String getPorcentagemTraidores() throws br.com.letscode.Excecoes.NaoHaTraidoresException {
    ...
    public String getPorcentagemRebeldes() throws br.com.letscode.Excecoes.NaoHaTraidoresException {
